...
export const toolCatalog: ToolCatalogItem[] = [
  ...
  },
  {
    ...
    description:
      "Screen land against a practical brief, track terrain and commute evidence, compare properties, and export a diligence memo.",
    category: "land",
    status: "prototype",
    href: "/tools/parcel/index.html",
    secondaryHref: "/land",
    docsHref: "/docs/MONETIZATION_READINESS.md",
    readinessNote: "Browser research workspace with optional AI-app handoff. Property claims require independent verification.",
    backendRequired: false,
    dataMode: "mixed",
    featured: true,
  },
  ...
  {
    id: "econ-arcade",
    name: "The Family Business · Econ Arcade",
    description: "A persistent pixel-art campaign connecting markets, strategy, finance, policy, and trade across six family ranks.",
    category: "games",
    status: "live",
    href: "/econ-arcade",
    secondaryHref: "/legacy-econ-arcade/play/",
