...
export const toolCatalog: ToolCatalogItem[] = [
  {
    ...
    description:
      "Define a land thesis, review source-aware parcel opportunities, compare candidates, and generate a memo-style diligence preview.",
    category: "land",
    status: "prototype",
    href: "/land",
    secondaryHref: "/tools/parcel/index.html",
    docsHref: "/docs/MONETIZATION_READINESS.md",
    readinessNote: "Prototype / research workflow; human verification required.",
  ...
  },
  {
    id: "land-desk",
    name: "Land Desk",
    description: "A focused landing page for parcel research positioning, limits, and the current prototype path.",
    category: "land",
    status: "prototype",
    href: "/land",
    secondaryHref: "/tools/parcel/index.html",
    readinessNote: "Research workflow; human verification required.",
    backendRequired: false,
    dataMode: "mixed",
  },
  {
