...
export const toolCatalog: ToolCatalogItem[] = [
  {
    ...
    description:
      "Build a land acquisition thesis, score parcel opportunities, compare shortlists, and generate a memo-style preview.",
    category: "land",
    status: "prototype",
    href: "/land",
    secondaryHref: "/tools/parcel/index.html",
    docsHref: "/docs/MONETIZATION_READINESS.md",
    readinessNote: "Research workflow; not verified acquisition advice.",
