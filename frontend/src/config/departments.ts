...
export const departments = [
  ...
  {
    id: "observatory",
    title: "Congressional Accountability",
    shortTitle: "Accountability",
    slug: "observatory",
    description:
      "An independent citizen workbench to follow bills, inspect public records, and compare promises with actions.",
    status: "prototype",
    type: "analysis",
    primaryRoute: "/tools/observatory/index.html",
    accentLabel: "Public Records",
    storyEnabled: true,
    toolEnabled: true,
  },
  {
