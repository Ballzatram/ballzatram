...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div
      className={`ballzatram-site-shell min-h-dvh text-[#f8ead1] ${isLandRoute ? "ballzatram-site-shell--land" : ""}`}
    >
      <a className="skip-link" href="#site-content">Skip to content</a>
      <header className={`ballzatram-site-header ${isLandRoute ? "ballzatram-site-header--land" : ""}`}>
