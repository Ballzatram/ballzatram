...
- `index.html` defines the responsive MacroBoard shell, AI-style process flow, upload controls, diagnostics panels, learning database, chart, and tables.
...
- Market prices are requested from the free Yahoo chart endpoint from the browser; if the host or browser blocks the request, MacroBoard keeps deterministic demo curves and labels the status.
